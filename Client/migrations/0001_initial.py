    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Client_Comment_Author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='client_Comment', to=settings.AUTH_USER_MODEL)),
                ('Comment_Client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='client', to='Client.Client')),
            ],
        ),
    ]
